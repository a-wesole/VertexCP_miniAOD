...
process.TFileService = cms.Service("TFileService",
    fileName =cms.string('TTree_1k_OSPV_Recovery.root'))
...
VertexCollection_PAT = "offlineSlimmedPrimaryVerticesRecovery"
...
process.output = cms.OutputModule("PoolOutputModule",
    fileName = cms.untracked.string('edm_noBDTrecovery.root'),
